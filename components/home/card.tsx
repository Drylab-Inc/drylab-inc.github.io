  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-lg text-center">
        <h1 className="bg-gradient-to-br from-foreground to-foreground/50 bg-clip-text font-display text-xl font-bold text-transparent [text-wrap:balance] md:text-3xl md:font-normal">
          <ReactMarkdown>{title}</ReactMarkdown>
        </h1>
        <div className="prose-sm mt-3 leading-normal text-foreground/50 [text-wrap:balance] md:prose">
          <ReactMarkdown
            components={{
              a: ({ node, ...props }) => (
                <a
