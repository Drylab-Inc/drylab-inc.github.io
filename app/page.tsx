...
import Cells from "@/public/com.png";
  ...
  return (
    <>
      <div className="z-10 w-full max-w-6xl  px-5 pb-10 pt-24 xl:px-0">
        ...
        <h1
          className="animate-fade-up bg-gradient-to-br from-foreground to-foreground/60 bg-clip-text text-center font-display text-4xl font-bold tracking-[-0.02em] text-transparent opacity-0 drop-shadow-sm [text-wrap:balance] md:text-7xl md:leading-[5rem]"
      ...
      >
        <a
          className="hover:bg-backgrounf group flex max-w-fit items-center justify-center space-x-2 rounded-full  border border-foreground bg-foreground px-5 py-2 text-sm text-background transition-colors hover:text-foreground"
          href="mailto:hi@effie.bio"
          target="_blank"
          rel="noopener noreferrer"
        >
