  ...
  return (
    <>
      <div className="z-10 w-full max-w-6xl  px-5 pb-10 pt-24 xl:px-0">
        ...
        <h1
          className="animate-fade-up bg-gradient-to-br from-foreground to-foreground/40 bg-clip-text text-center font-display text-4xl font-bold tracking-[-0.02em] text-transparent opacity-0 drop-shadow-sm [text-wrap:balance] md:text-7xl md:leading-[5rem]"
